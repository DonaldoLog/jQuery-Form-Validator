...
(function($, window) {
  ...
  $(window).bind('validatorsLoaded', function() {
    ...
    $.formUtils.LANG = {
      ...
      lengthBadStart: 'El campo debe contener entre ',
      ...
      andSpaces: ' y https://github.com/victorjonsson/jQuery-Form-Validatorespacios ',
      badInt: 'El valor proporcionado no es un número',
      ...
      badAlphaNumeric: 'El campo solo debe contener caracteres alfanuméricos (a-z y números)',
